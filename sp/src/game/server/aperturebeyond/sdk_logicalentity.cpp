...
public:
	...
	void InputTickTwice(inputdata_t &inputData);
...
// Links our input name from Hammer to our input member function
DEFINE_INPUTFUNC(FIELD_VOID, "FireTwice", InputTickTwice),
...
// Purpose: Handle a tick input from another entity
//-----------------------------------------------------------------------------
void CMyLogicalEntity::InputTickTwice(inputdata_t &inputData)
{
	// Increment our counter
	m_nCounter++;
	m_nCounter++;
